...
public class AdsConversionRate {
    ...
    public static void main(String[] args) {
        ...
        adsConversionRate(completedPurchaseUserIds, adClicks, allUserIps);
    }

    public static void adsConversionRate(List<String> completedPurchaseUserIds, List<String> adClicks, List<String> allUserIps) {
        ...
        for (String click : adClicks) {
            ...
            conversion.putIfAbsent(adText, new int[2]);
            conversion.get(adText)[1]++;

            if (userIds.contains(ipToUserId.get(ip))) {
        ...
        for (Map.Entry<String, int[]> entry : conversion.entrySet()) {
            ...
            System.out.println(ratio[0] + " of " + ratio[1] + " " + adText);
        }
    }
}